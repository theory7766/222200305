...
public class UserController {
    ...
    public QueryRequest userRegister(@RequestBody User user) {
//        System.out.println(user);
    ...
    public QueryRequest<Article> getUserInformation(HttpServletRequest request) {
        ...
        HashMap<String, String> task = userService.getUserInformation(user_id);
        return new QueryRequest<>(Base.success(), task);
    }
